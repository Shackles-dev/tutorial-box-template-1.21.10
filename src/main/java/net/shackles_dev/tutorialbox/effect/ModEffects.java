...
public class ModEffects {
    ...
    private static RegistryEntry<StatusEffect> registerStatusEffect(String name, StatusEffect statusEffect) {
        return Registry.registerReference(Registries.STATUS_EFFECT, Identifier.of(TutorialBox.MOD_ID, name), statusEffect);
    }

    public static void registerModdedEffects() {
        TutorialBox.LOGGER.info("casting custom effects for " + TutorialBox.MOD_ID + '!');
    }
}
